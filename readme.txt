div要水平居中,可以margin:0 auto来实现.注意此div必须有宽度.
文字垂直居中可以line-height=height来实现.
...
文字溢出显示为省略号，可以通过text-overflow: ellipsis
